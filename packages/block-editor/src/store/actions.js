...
function* ensureDefaultBlock() {
	const count = yield syncSelect( 'core/block-editor', 'getBlockCount' );
...
export function* selectPreviousBlock( clientId ) {
	const previousBlockClientId = yield syncSelect(
		'core/block-editor',
...
export function* selectNextBlock( clientId ) {
	const nextBlockClientId = yield syncSelect(
		'core/block-editor',
...
export function* replaceBlocks(
	...
	blocks = getBlocksWithDefaultStylesApplied(
		castArray( blocks ),
		yield syncSelect( 'core/block-editor', 'getSettings' )
	);
	const rootClientId = yield syncSelect(
		'core/block-editor',
	...
	for ( let index = 0; index < blocks.length; index++ ) {
		...
		const canInsertBlock = yield syncSelect(
			'core/block-editor',
			'canInsertBlockType',
			block.name,
			rootClientId
...
export function* moveBlocksToPosition(
	...
	const templateLock = yield syncSelect(
		'core/block-editor',
		'getTemplateLock',
		fromRootClientId
	);
	...
	const canInsertBlocks = yield syncSelect(
		'core/block-editor',
		'canInsertBlocks',
		clientIds,
		toRootClientId
...
export function* insertBlocks(
	...
	for ( const block of blocks ) {
		const isValid = yield syncSelect(
			'core/block-editor',
			'canInsertBlockType',
			block.name,
			rootClientId
...
export function* removeBlocks( clientIds, selectPrevious = true ) {
	...
	const isLocked = yield syncSelect(
		'core/block-editor',
		'getTemplateLock',
		rootClientId
	);
	...
	if ( selectPrevious ) {
		...
		previousBlockId = yield syncSelect(
			'core/block-editor',
			'getPreviousBlockClientId',
			clientIds[ 0 ]
		);
...
export function* duplicateBlocks( clientIds, updateSelection = true ) {
	...
	const lastSelectedIndex = yield syncSelect(
		'core/block-editor',
		'getBlockIndex',
...
export function* insertBeforeBlock( clientId ) {
	...
	const firstSelectedIndex = yield syncSelect(
		'core/block-editor',
		'getBlockIndex',
		clientId,
		rootClientId
